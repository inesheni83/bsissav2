...
/**
* @see \App\Http\Controllers\Invoice\InvoiceController::createFromOrder
 * @see app/Http/Controllers/Invoice/InvoiceController.php:75
 * @route '/admin/orders/{order}/create-invoice'
 */
export const createFromOrder = (args: { order: number | { id: number } } | [order: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/orders/{order}/create-invoice'
 */
createFromOrder.url = (args: { order: number | { id: number } } | [order: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { order: args }
    }
 ...
 * @route '/admin/orders/{order}/create-invoice'
 */
createFromOrder.post = (args: { order: number | { id: number } } | [order: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: createFromOrder.url(args, options),
    method: 'post',
})
...
const InvoiceController = { index, download, createFromOrder, updateStatus, updatePaymentStatus }
