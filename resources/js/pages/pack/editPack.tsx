...
export default function EditPack({ pack, products }: PageProps) {
    ...
    const [formData, setFormData] = useState({
        ...
        reference_price: pack.reference_price?.toString() || '',
        is_active: pack.is_active,
        stock_quantity: pack.stock_quantity.toString(),
    });
    ...
    >(pack.gallery_images?.map((img) => ({ url: img.url, path: img.path })) || []);
    ...
    // Initialize selected products from pack data
    useEffect(() => {
        const initialProducts: SelectedProduct[] = pack.products.map((product) => ({
    ...
    const handleGalleryImagesChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        const totalImages = existingGalleryImages.length + galleryImages.length;
                ...
                <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-600">{pack.name}</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Modifiez les détails principaux du pack
                                </CardDescription>
                            </CardHeader>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    {mainImagePreview
                                        ? 'Modifier l\'image principale (optionnel)'
                                        : 'Ajoutez une image principale (JPG ou PNG, max 5MB)'}
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                {mainImagePreview ? (
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Gérez jusqu'à 5 images supplémentaires (optionnel)
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Modifiez les produits inclus dans le pack
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
