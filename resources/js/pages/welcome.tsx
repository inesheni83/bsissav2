import { dashboard, dashboardSeller, login, register } from '@/routes/index';
            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                <header className="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        {/* Bouton vendeur si role = vendeur */}
                        {auth.user && auth.user.role === 'client' && (
                            <Link
                                href={dashboardSeller()}
                                className="inline-flex items-center rounded-md bg-gradient-to-r from-orange-500 to-red-500 px-4 py-1.5 text-sm font-medium text-white shadow-sm hover:from-orange-600 hover:to-red-600 transition"
                            >
                                Vendeur
                            </Link>
                        )}
...
<button className="flex h-9 w-9 items-center justify-center rounded-full border border-gray-300 bg-white text-gray-700 shadow-sm hover:bg-gray-100 dark:bg-[#161615] dark:text-[#EDEDEC] dark:hover:bg-[#1f1f1f]">                                    <User className="h-4 w-4" />
                                </button>
                            </DropdownMenuTrigger>
